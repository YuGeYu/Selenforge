...
const LOCALSTORAGE_KEY = 'selenforge-editor-latest-release-notes';
...
const createVersion = () => {
    ...
    btnVersion.on('click', () => {
        ...
        openBrandLink(BRAND_LINKS.releaseNotes, 'Release Notes');
    });

    tooltip().attach({
        container: tooltipSimpleItem({ text: 'View Selenforge release notes' }),
        target: btnVersion,
        align: 'bottom',
        arrowAlign: 'end'
    });
