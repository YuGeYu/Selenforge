    ...
    const menu = new Menu({
        items: [{
            ...
            items: [{
                ...
                text: 'User Manual',
                icon: 'E232',
                onSelect: () => openBrandLink(BRAND_LINKS.manual, 'User Manual')
            }, {
                text: 'Tutorials',
                icon: 'E232',
                onSelect: () => openBrandLink(BRAND_LINKS.tutorials, 'Tutorials')
            }, {
                text: 'API Reference',
                icon: 'E232',
                onSelect: () => openBrandLink(BRAND_LINKS.apiReference, 'API Reference')
            }, {
                text: 'Forum',
                icon: 'E233',
                onSelect: () => openBrandLink(BRAND_LINKS.forum, 'Forum')
            }, {
                text: 'Log Issue',
                icon: 'E259',
                onSelect: () => openBrandLink(BRAND_LINKS.issues, 'Issue Tracker')
            }, {
                text: 'How do I...',
                icon: 'E138',
